...
```
cd existing_repo
git remote add origin https://gitlab.com/tw-p3/front-and-back.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tw-p3/front-and-back/-/settings/integrations)
